drop table if exists  ruota_BA_archivio;

CREATE TABLE ruota_BA_archivio(
...
INSERT INTO ruota_selectata_arhiva(data,ruota,n1,n2,n3,n4,n5, vn,vc, d1,d2,d3,d4,d5, dp,di, v1,v2,v3,v4,v5, c1_1,c1_2,c1_3,c1_4,c1_5,c1_6,c1_7,c1_8,c1_9, c2_0,c2_1,c2_2,c2_3,c2_4,c2_5,c2_6,c2_7,c2_8,c2_9)
SELECT  
    data,
    ruota,
    n1,
...
FROM
    `storico_filtrato_5`
WHERE ruota IN (SELECT rs.ruota FROM ruote AS rs WHERE id = 1) ORDER BY data ASC;    
